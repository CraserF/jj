...
impl TruncatedEvolutionGraph {
    ...
    pub async fn new(
        ...
        // The adjacency list, with commits pointing to their successors.
        ...
        let initial_node = if initial_nodes.len() == 1 {
            ...
            adj.entry(root_commit_id.clone())
                .or_default()
                .extend(initial_nodes);
            root_commit_id
        };

        let flow_graph = FlowGraph::new(SimpleDirectedGraph::new(adj), initial_node);
        Ok(Self {
